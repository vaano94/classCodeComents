...
public class ConvertingComparator<S, T> implements Comparator<S> {
    ...
    /**
     * Create a new {@link org.springframework.core.convert.converter.ConvertingComparator} instance.
    ...
    public ConvertingComparator(
        ...
        this(comparator, new org.springframework.core.convert.converter.ConvertingComparator.ConversionServiceConverter<S, T>(conversionService, targetType));
    }
    ...
    /**
     * Create a new {@link org.springframework.core.convert.converter.ConvertingComparator} that compares {@link java.util.Map.Entry
     ...
     * @return a new {@link org.springframework.core.convert.converter.ConvertingComparator} instance
     */
    public static <K, V> org.springframework.core.convert.converter.ConvertingComparator<Map.Entry<K, V>, K> mapEntryKeys(Comparator<K> comparator) {
        return new org.springframework.core.convert.converter.ConvertingComparator<Map.Entry<K,V>, K>(comparator, new Converter<Map.Entry<K, V>, K>() {
            @Override
     ...
     * @return a new {@link org.springframework.core.convert.converter.ConvertingComparator} instance
     */
    public static <K, V> org.springframework.core.convert.converter.ConvertingComparator<Map.Entry<K, V>, V> mapEntryValues(Comparator<V> comparator) {
        return new org.springframework.core.convert.converter.ConvertingComparator<Map.Entry<K,V>, V>(comparator, new Converter<Map.Entry<K, V>, V>() {
            @Override
